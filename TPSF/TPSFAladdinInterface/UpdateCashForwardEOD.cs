...
*-------------------------------------------------------------------------
*                                                                           
*   File Name: UpdateCashForwardEOD.cs                                                 
...
namespace UpdateCashForwardEOD
{
    class UpdateCashForwardEOD
    {
        //Get Logger Object
        ...
        static void Main(string[] args)
        {
            ...
            logger.Info("************ BEGIN: Update CashForward EOD***********");
            MiscellaneousDAO miscDAO = new MiscellaneousDAO();
            try
            { 
                miscDAO.UpdateCashForwardEOD(); 
            }
            catch (Exception e)
            {
            ...
            {
                logger.Info("************ END: Update CashForwardEOD ***********");
